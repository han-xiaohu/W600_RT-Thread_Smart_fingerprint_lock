...
- 网络自动检测保持连接状态
- 安卓APP控制开门和查看历史记录（未完成）




## 2.硬件电路
![image](.assets/rt-thread/images/硬件.png)
...
![image](.assets/rt-thread/images/主要代码.png)
...
![image](.assets/rt-thread/images/目录结构.png)
...
![image](.assets/rt-thread/images/项目文件.png)

固件生成在当前示例所在目录的Bin文件夹下。

![image](.assets/rt-thread/images/编译文件.png)

### 4.2 烧录
打开星通智联下载调试软件选择`rtthread_layout_1M.FLS`烧录,型号可以不选，如果串口没有连接接复位，点击下载后需要手动复位W600。

![image](.assets/rt-thread/images/下载.png)
